...
console.log("Start");
console.log("This is Lokesh Melkani");
console.log("End");
...
const message = importantAction("Lokesh Melkani");

console.log(message);

console.log("End");

// What can we do to make message = This is Lokesh Melkani?
...
const message1 = importantAction1("Lokesh Melkani", function (message) {
  console.log(message);
});
