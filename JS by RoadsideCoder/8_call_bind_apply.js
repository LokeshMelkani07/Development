...
console.log(sayHello.call(obj, 24)); // Hello Lokesh is 24
...
console.log(sayHello.apply(obj, [24])); // Hello Lokesh is 24
...
console.log(bindFunc(24)); // Hello Lokesh is 24
console.log(bindFunc(25)); // Hello Lokesh is 25
...
console.log(sayHi.call(person, 24)); // Lokesh is 24
...
// so below chaining will not change the name to lokesh, it will remain to john
function f1() {
  console.log(this.name);
}

f = f.bind({ name: "John" }).bind({ name: "Lokesh" });
f(); // Object { name: "John" }
...
function checkPassword(success, failed) {
  ...
  if (password == "Lokesh Melkani") success();
  else failed();
}
